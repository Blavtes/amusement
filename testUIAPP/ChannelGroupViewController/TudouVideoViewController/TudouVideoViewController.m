...
@interface TudouVideoViewController ()

@end

@implementation TudouVideoViewController
...
- (void)viewDidLoad
{
    ...
    NSString *strUrl=[NSString stringWithFormat: @"http://m.tudou.com/"];
