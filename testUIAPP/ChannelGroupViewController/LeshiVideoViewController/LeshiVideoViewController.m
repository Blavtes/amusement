...
@interface LeshiVideoViewController ()

@end

@implementation LeshiVideoViewController
...
- (void)viewDidLoad
{
    ...
    NSString *strUrl=[NSString stringWithFormat: @"http://m.letv.com/"]; 
