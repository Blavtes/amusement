...
@interface SohuVideoViewController ()

@end

@implementation SohuVideoViewController
...
- (void)viewDidLoad
{
    ...
    NSString *strUrl=[NSString stringWithFormat: @"http://m.tv.sohu.com/channel/"];
