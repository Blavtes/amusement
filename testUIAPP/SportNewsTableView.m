...
@interface SportNewsTableView() <NSXMLParserDelegate>
...
@end
@implementation SportNewsTableView
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    for (NSString *str in array) {
        ...
        if ([[array1 objectAtIndex:([array1 count]-1)] isEqualToString:@""] == NO ) {
            ...
            cell.newsTtile.text =[NSString stringWithFormat:@"[体育]:%@",[array1 objectAtIndex:([array1 count]-1)]];
