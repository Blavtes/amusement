//
//  ForeignNewTableViewController.m
//  testUIAPP
//
...
@interface ForeignNewTableViewController() <NSXMLParserDelegate>
...
@end
@implementation ForeignNewTableViewController
...
{
    [super viewDidLoad];
    self.title = @"新闻中心*国外新闻";
    self.navigationItem.title = @"新闻中心*国外新闻";
    self.navigationController.title = @"新闻中心*国外新闻";
    NSXMLParser *xmlParser = [[NSXMLParser alloc] initWithContentsOfURL:[NSURL URLWithString:@"http://rss.sina.com.cn/news/world/focus15.xml"]];
    self.tempString = nil;
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    for (NSString *str in array) {
        ...
        if ([[array1 objectAtIndex:([array1 count]-1)] isEqualToString:@""] == NO ) {
            ...
            cell.newsTtile.text = [NSString stringWithFormat:@"[国外]:%@", [array1 objectAtIndex:([array1 count]-1)]];
