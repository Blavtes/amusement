//
//  EnterTainmentNewsTableViewController.m
//  testUIAPP
//
...
@interface EnterTainmentNewsTableViewController() <NSXMLParserDelegate>
...
@end
@implementation EnterTainmentNewsTableViewController
...
{
    [super viewDidLoad];
    NSXMLParser *xmlParser = [[NSXMLParser alloc] initWithContentsOfURL:[NSURL URLWithString:@"http://rss.sina.com.cn/ent/hot_roll.xml"]];
    self.tempString = nil;
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    for (NSString *str in array) {
        ...
        if ([[array1 objectAtIndex:([array1 count]-1)] isEqualToString:@""] == NO ) {
            ...
            cell.newsTtile.text =[NSString stringWithFormat:@"[娱乐]:%@",[array1 objectAtIndex:([array1 count]-1)]];
